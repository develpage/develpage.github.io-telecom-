$(document).ready(function() {
    ...
    var bg3ParallaxScene = new ScrollMagic.Scene({
            triggerElement: '.short-services',
            offset: -1100,
            duration: '150%',
            triggerHook: 0
        })
        .setTween(TweenMax.from('.short-services-bg', 0.1, { y: '100%', ease: Linear.easeNone }))
        //.addIndicators()
        .addTo(controller);
    ...
    var shortServBG = new ScrollMagic.Scene({
        ...
        .setPin('.short-services-bg')
        //.addIndicators()
        .addTo(controller);

    var shortServBGParallax = new ScrollMagic.Scene({
            triggerElement: '.short-services-bg',
            offset: 500,
            duration: '200%',
            triggerHook: 0
        })
        .setTween(TweenMax.to('.short-services-bg', 1, { x: '100%', ease: Linear.easeNone }))
        .addIndicators()
        .addTo(controller);
...
//Parallax gallery ********************************************************************
    ...
    var galleryParallaxImg1 = new ScrollMagic.Scene({
        ...
        .setTween(TweenMax.from('.gi1', 1, { y: '-15%', ease: Linear.easeNone }))
       // .addIndicators()
        .addTo(controller);
...
// Customers background Parallax effect **********************************************
  ...
  var customersParallaxBg = new ScrollMagic.Scene({
        ...
        .setTween(TweenMax.from('.customers-bg', 1, { y: '-10%', ease: Linear.easeNone }))
        //.addIndicators()
        .addTo(controller);
